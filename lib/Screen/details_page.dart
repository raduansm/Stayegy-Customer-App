                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Text(
                                                ...
                                                timeRange == null
                                                    ? '${DateFormat('dd-MM-yy').format(DateTime.now())}  -  ${DateFormat('dd-MM-yy').format(DateTime.now().add(Duration(days: 1)))}'
                                                              ...
                                                              switch (
                                                                ...
                                                                case 2:
                                                                  if (roomType1 !=
                                                                    ...
                                                                    roomsPrice =
                                                                        [];
                                                                    totalDiscountedPrice = hotel.discountedPrice[
                                                                            roomType1] +
                                                                        hotel.discountedPrice[
                                                                            roomType2];
